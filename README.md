...
- Optional: UP/DOWN on pre-prediction can place a **PancakeSwap BNB prediction** on BSC if you set `BSC_WALLET_PRIVATE_KEY` in `.env` (see `RULES.md` — use a hot wallet, never commit keys)
